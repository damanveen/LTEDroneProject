...
public class MediaTransmit {  
    ...
    public MediaTransmit(String ipAddress, String pb) {  
        ...
        if (audio != null && audio.size() > 0) {  
            ...
            System.out.println("Error no voice device");  
        }  
        ...
        if (video != null && video.size() > 0) {  
            ...
            System.out.println("Error no video device");  
        }  
    ...
    public static void main(String[] args) {  
        //String[] strs = { "localhost", "9994" };  //(ip and port)
        new MediaTransmit("localhost", "9994");  
    }  
}  
